...
public:
  ...
  // READ_FEATURE(OmpInteropVar)
  // READ_FEATURE(OmpInteropVar::InteropVar)
  // READ_FEATURE(OmpDestroyClause)
  // READ_FEATURE(OmpDestroyClause::InteropVar)
  // READ_FEATURE(OmpUseClause)
  // READ_FEATURE(OmpUseClause::InteropVar)
  // READ_FEATURE(DeviceType)
  // READ_FEATURE(DeviceContextType)
  // READ_FEATURE(PlatformType)
  // READ_FEATURE(OmpTarget)
  // READ_FEATURE(OmpTargetSync)
  // READ_FEATURE(OmpInteropVar)
  READ_FEATURE(OmpDestroyClause)
  // READ_FEATURE(OmpDestroyClause::InteropVar)
  READ_FEATURE(OmpUseClause)
  ...
  // READ_FEATURE(OmpInteropModifier)
