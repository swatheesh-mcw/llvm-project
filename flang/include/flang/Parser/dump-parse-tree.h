...
#include "llvm/Frontend/OpenMP/OMP.inc"
  ...
  // NODE(parser, OmpInteropVar)
  // NODE(OmpInteropVar, InteropVar)
  // NODE(parser, OmpInteropVar)
  NODE(parser, OmpDestroyClause)
  // NODE(InteropVarObj, OmpObject)
  ...
  // NODE(parser, DeviceType)
  // NODE(parser, DeviceContextType)
  // NODE(parser, PlatformType)
  // NODE(parser, OmpTarget)
  // NODE(parser, OmpTargetSync)
  // NODE(parser, OmpInteropType)
  // NODE_ENUM(OmpInteropType, InteropType)
  // NODE(parser, OmpPreferenceListType)
  // NODE(parser, OmpInteropModifier)
